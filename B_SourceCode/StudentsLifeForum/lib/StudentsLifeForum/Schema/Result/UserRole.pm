use utf8;
package StudentsLifeForum::Schema::Result::UserRole;
...
Related object: L<StudentsLifeForum::Schema::Result::Role>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ruXNN8gXRBgXVlek460Itw
